...
final class Version20250331133313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE participant ADD campus_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE participant ADD pseudo VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_D79F6B115126AC48
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX UNIQ_D79F6B1186CC499D
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_D79F6B11AF5D55E1
        SQL);
        $this->addSql(<<<'SQL'
